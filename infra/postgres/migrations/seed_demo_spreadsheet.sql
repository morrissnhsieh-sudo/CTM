...
VALUES
  ...
  -- Col 11: Attachment column (NEW)
  ('f0000001-0000-0000-0000-000000000012',
   'ee000001-0000-0000-0000-000000000001',
   'Files', 'attachment', 11, 150, false, false,
   '{}'::jsonb, NULL)
...
INSERT INTO cells (row_id,col_id,value,updated_by) VALUES
  ...
  ('e1000001-0000-0000-0000-000000000001','f0000001-0000-0000-0000-000000000012','iphone15pro_spec_sheet.pdf','6a586195-661b-4cc1-bcff-92b0a215bd8d')
ON CONFLICT DO NOTHING;
